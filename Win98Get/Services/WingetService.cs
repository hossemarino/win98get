...
public sealed class WingetService
{
    ...
    public Task<int> InstallStreamingAsync(string packageId, Action<string> onOutputLine, CancellationToken cancellationToken)
        => RunWingetStreamingAsync($"install --id \"{packageId.Replace("\"", "\\\"")}\" --accept-source-agreements --accept-package-agreements", onOutputLine, cancellationToken);

    public Task<int> UpgradeStreamingAsync(string packageId, Action<string> onOutputLine, CancellationToken cancellationToken)
        => RunWingetStreamingAsync($"upgrade --id \"{packageId.Replace("\"", "\\\"")}\" --include-unknown --accept-source-agreements --accept-package-agreements", onOutputLine, cancellationToken);

    public Task<int> UpgradeAllStreamingAsync(Action<string> onOutputLine, CancellationToken cancellationToken)
        => RunWingetStreamingAsync("upgrade --all --include-unknown --accept-source-agreements --accept-package-agreements", onOutputLine, cancellationToken);

    public Task<int> UninstallStreamingAsync(string packageId, Action<string> onOutputLine, CancellationToken cancellationToken)
        => RunWingetStreamingAsync($"uninstall --id \"{packageId.Replace("\"", "\\\"")}\"", onOutputLine, cancellationToken);
